...
(function() {
    ...
    // Loop to keep a nearly unhearable sound playing to keep the timers running
...
// Sound in Base64 to keep the timeouts/intervals running properly even without the window being focused
